...
public abstract class DiaperPridev1AItem extends ArmorItem {
	...
	public DiaperPridev1AItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Leggings extends DiaperPridev1AItem {
		public Leggings() {
